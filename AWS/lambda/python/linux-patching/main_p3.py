...
def lambda_handler(event, context):
    ...
    if packagename == "":
        logger.info('Skipping packagename finding (could not find package_name)')
        return 1    
    ...
    response = ssm.send_command(
        ...
        Comment = f'Lambda function performing Inspector {cveId} finding auto-remediation',
